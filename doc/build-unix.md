UNIX BUILD NOTES
====================
Some notes on how to build NXBoost in Unix.
...
This will build nxboost-qt as well if the dependencies are met.
...
memory available when compiling NXBoost Core. With 512MB of memory or less
...
Once these are installed, they will be found by configure and a nxboost-qt executable will be
built by default.

Notes
-----
The release is built with GCC and then "strip nxboostd" to strip the debug
...
Security
--------
To help make your NXBoost installation more secure by making certain attacks impossible to
