...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("NXBoost Core nxboost-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nxboost-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nxboost transaction") + "\n" +
                               "  nxboost-tx [options] -create [commands]   " + _("Create hex-encoded nxboost transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nxboost transaction
