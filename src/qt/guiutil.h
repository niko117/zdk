...
/** Utility functions used by the NXBoost Qt UI.
 */
namespace GUIUtil
{
...
// Render NXBoost addresses in monospace font
...
// Parse "nxboost:" URI into recipient object, return true on successful parsing
