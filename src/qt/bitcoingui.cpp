                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("NXBoost-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NXBoost address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and nxboost: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About NXBoost Core"), this);
    aboutAction->setStatusTip(tr("Show information about NXBoost Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NXBoost"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NXBoost addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NXBoost addresses"));
    ...
    openAction->setStatusTip(tr("Open a NXBoost: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NXBoost Core help message to get a list with possible NXBoost command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("NXBoost Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NXBoost network", "", count));
}
...
{
    QString strTitle = tr("NXBoost Core"); // default title
